...
const ModalityNotAvailableAtCenterEscalation = () => {
  ...
  return (
    <EscilationErrorBoxWrapper>
      <ErrorMessage
        eroorHeading={"Currently we do not offer requested service"}
...
export default ModalityNotAvailableAtCenterEscalation;
