...
const SpecialServicesNotHandledByAiEscalation = () => {
  ...
  return (
    <EscilationErrorBoxWrapper>
      <ErrorMessage
        eroorHeading={`Sorry we dont take ${curr?.modalityGeneric} ${curr?.bodyPart} over AI`}
...
export default SpecialServicesNotHandledByAiEscalation;
