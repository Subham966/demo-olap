...
const CallerRequestedForAnOperatorEscalation = () => {
  ...
  return (
    <EscilationErrorBoxWrapper>
      <ErrorMessage
        ...
        eroorHeading={
          "Thanks for your time. You can reach out when you would like to book an appointment"
        }
        CloseButton={
          <CustomCssButton
            sx={{
...
export default CallerRequestedForAnOperatorEscalation;
