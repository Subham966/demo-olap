...
const WalkinAppointmentEscalation = () => {
  ...
  return (
    <EscilationErrorBoxWrapper>
      <ErrorMessage2
        eroorHeading={`You can walk in for '${useServiceRequestUtterance}' without an appointment`}
        eroorSubHeading={`Visit us during our business hours with your doctor's referral`}
        message={"Our business hours are:"}
        additionalMessage={`For any enquiries, please contact us on ${centerDetails?.public_number}`}
        CloseButton={
          <CustomCssButton
            sx={{
              fontWeight: "600",
...
export default WalkinAppointmentEscalation;
