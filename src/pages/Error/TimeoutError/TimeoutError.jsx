...
import { ContainerMobile } from "./TimeoutError.mobile.style";
import { ContainerDesktop } from "./TimeoutError.desktop.style";
...
function TimeoutError() {
  ...
  return (
    <ContainerWrapper>
      <ErrorMessage
        eroorHeading={"Sorry, it looks like there is a Timeout Error"}
