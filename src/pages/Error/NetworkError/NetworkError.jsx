...
import { ContainerMobile } from "./NetworkError.mobile.style";
import { ContainerDesktop } from "./NetworkError.desktop.style";
...
function NetworkError() {
  ...
  return (
    <ContainerWrapper>
      <ErrorMessage
        eroorHeading={"Sorry, it looks like there is still a Network Error"}
