...
color:black ;
`;
const ContactNumber = styled(Box)`
font-weight:500 ;
`;
...
export { CustomContainer,ErrorIconBox, HelpTextBox ,ErrorHeading ,HelpTextHeading,ErrorSubHeading,AdditionalMessage,CancelButton,ContactNumber};
